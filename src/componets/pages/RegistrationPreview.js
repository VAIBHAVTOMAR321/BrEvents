      ...
      <div className="government-form-preview position-relative">
        ...
        <div className="official-header text-center py-4 border-bottom border-dark">
          ...
          <div className="current-date mt-2">
            ...
            {userId && (
              <p className="mb-0 small font-weight-bold mt-2" style={{ color: '#005f9e', fontSize: '1.1rem' }}>
        ...
        {isVerified && (
          <Alert variant="info" className="mb-3 no-print">
            ...
            Email Verified Successfully! Your registration is complete. You can now download or print your registration preview.
          </Alert>
        )}
